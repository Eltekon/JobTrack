                  ...
                  <div class="x_content">
                   <form id="demo-form2" name="form" method="post" class="form-horizontal form-label-left" data-parsley-validate="" novalidate="">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="spec_no" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text">
                        </div>
                        <?php echo form_error('spec_no'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="tittle" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text">
                        </div>
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="issue_no" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text">
                        </div>
                          <?php echo form_error('issue_no'); ?>
                        </div>
                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
                        Latest version:
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="version" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text">
                        </div>

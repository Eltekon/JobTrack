                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   <form id="demo-form2" name="form" method="post" class="form-horizontal form-label-left" data-parsley-validate="" novalidate="">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-9">Name:</label>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                      <input  name="name" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text">
                         ...
                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-9">Designation:</label>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                         ...
                         <?php echo form_error('designation'); ?>
                           ...
                           <div class="form-group">
                         <label class="control-label col-md-3 col-sm-3 col-xs-9">User Group :</label>
                                <div class="col-md-6 col-sm-6 col-xs-9">
                         ...
                         <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-9">Department:</label>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                         ...
                         <?php echo form_error('department'); ?>
                            ...
                            <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-9">User Name:</label>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                      <input  name="User_name" id="User_name" class="form-control col-md-7 col-xs-9" required="required" type="text" placeholder="e.g. Abc@gmail.com"> 
                      </div>
                        <?php echo form_error('User_name'); ?>
                      </div> 
                      
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-9">Password:</label>
                       <div class="col-md-6 col-sm-6 col-xs-9">
                      <input  name="Password" id="Password" class="form-control col-md-7 col-xs-9" required="required" type="Password"> 
                      </div>

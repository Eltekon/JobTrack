                  ...
                  <div class="x_content">
                   <form id="demo-form2" name="form" method="post" class="form-horizontal form-label-left" data-parsley-validate="" novalidate="">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="vRoleName" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text" placeholder="Enter role">
                        <?php echo form_error('vRoleName'); ?>
                        </div>
                        </div>

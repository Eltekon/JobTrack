 ...
 <?php $update =$this->dbqry->getrecordbyidrow("ats_department","id",$id); ?>
<!-- page content -->
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   <form id="demo-form2" name="form" method="post" class="form-horizontal form-label-left" data-parsley-validate="" novalidate="">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-9">
                        <input  name="department" id="first-name" class="form-control col-md-7 col-xs-9" required="required" type="text" value="<?php echo $update->department;?>">
                        </div>
                        </div>
                 ...
                 <option value="inactive" <?php if($update->status == "inactive") { echo 'selected';}?>> inactive</option>
                       ...
                       <a class="btn btn-primary" type="button" href="<?php echo base_url('admin/department/department_view/');?>">Cancel</a>
                        </form>
                        </div>
                    <div class="row">
